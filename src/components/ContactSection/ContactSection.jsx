...
import styles from "./ContactSection.module.css"; // CSS Module
  ...
  return (
    <div className={styles.eConInner}>
      <div className={styles.eCon}>
        ...
        <div
          className={`${styles.contactInfo} ${styles.animated} ${styles.fadeInUp}`}
        >
          <div className={styles.elementskitInfobox}>
            <div className={styles.elementskitInfoBoxIcon}>
              <svg
            ...
            <div className={styles.boxBody}>
              <h3 className={styles.elementskitInfoBoxTitle}>
                تماس با مرکز پشتیبانی
              </h3>
              <p>
                <a href="tel:+18091206705">۰۲۱-۸۸۸۸۸۸۸۸</a>
              </p>
            </div>
          </div>
        </div>
